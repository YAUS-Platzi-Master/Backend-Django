    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.userprofile')),
            ],
            options={
                'ordering': ('-created',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('set_url_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.seturl')),
            ],
            options={
                'ordering': ('-created',),
            },
